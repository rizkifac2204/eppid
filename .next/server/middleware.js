...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_C_3A_5CSRC_20Personal_5CAPPNEXTJS_5Cbasenextjs_matchers_W3sicmVnZXhwIjoiXig_2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg_2FOlxcLyhhZG1pbi4qKSkoLmpzb24pP1tcXC8jXFw_2FXT8kIn0seyJyZWdleHAiOiJeKD86XFwvKF9uZXh0XFwvZGF0YVxcL1teL117MSx9KSk_2FXFwvbG9naW4oLmpzb24pP1tcXC8jXFw_2FXT8kIn1d_)
});
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.js&page=%2Fmiddleware&rootDir=C%3A%5CSRC%20Personal%5CAPPNEXTJS%5Cbasenextjs&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLyhhZG1pbi4qKSkoLmpzb24pP1tcXC8jXFw%2FXT8kIn0seyJyZWdleHAiOiJeKD86XFwvKF9uZXh0XFwvZGF0YVxcL1teL117MSx9KSk%2FXFwvbG9naW4oLmpzb24pP1tcXC8jXFw%2FXT8kIn1d!

        

        enhanceGlobals()

        var mod = __webpack_require__(502)
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_js_page_2Fmiddleware_rootDir_C_3A_5CSRC_20Personal_5CAPPNEXTJS_5Cbasenextjs_matchers_W3sicmVnZXhwIjoiXig_2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg_2FOlxcLyhhZG1pbi4qKSkoLmpzb24pP1tcXC8jXFw_2FXT8kIn0seyJyZWdleHAiOiJeKD86XFwvKF9uZXh0XFwvZGF0YVxcL1teL117MSx9KSk_2FXFwvbG9naW4oLmpzb24pP1tcXC8jXFw_2FXT8kIn1d_(opts) {
          return adapter({
              ...opts,
              page: "/middleware",
              handler,
...
function subtleDsa(alg, algorithm) {
    ...
    switch (alg) {
        ...
        case 'EdDSA':
            if (env_isCloudflareWorkers() && algorithm.name === 'NODE-ED25519') {
...
var cookie = __webpack_require__(457);
...
async function setUserCookie(data, res) {
    const token = await new SignJWT(data).setProtectedHeader({
        alg: "HS256"
    }).setJti(nanoid()).setIssuedAt().setExpirationTime("30d").sign(new TextEncoder().encode(process.env.JWT_SECRET_KEY));
...
async function middleware(req, res) {
    ...
    if (pathname.startsWith("/login")) {
        if (verifiedToken) return server.NextResponse.redirect(`${origin}/admin`);
    }
...
var _addLocale = __webpack_require__(281);
function formatNextPathnameInfo(info) {
