...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,middlewares_Handler__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)().get(async (req, res)=>{
    try {
        const result = await libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"].select */ .Z.select(`survey.*`, `bawaslu.nama_bawaslu`, `pemohon.*`, "provinsi.provinsi").from("survey").innerJoin("bawaslu", "survey.bawaslu_id", "bawaslu.id").innerJoin(`pemohon`, `survey.email_pemohon`, `pemohon.email_pemohon`).leftJoin("provinsi", "provinsi.id", "bawaslu.provinsi_id").modify((builder)=>(0,middlewares_Condition__WEBPACK_IMPORTED_MODULE_3__/* .conditionWillSpesific */ .EA)(libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z, builder, req.session.user, "survey")).orderBy("survey.created_at", "desc");
        res.json(result);
    } catch (error) {
    ...
    try {
        ...
        const proses = await (0,libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("survey").whereIn("id", arrID).del();
...
var __webpack_exports__ = __webpack_require__.X(0, [4383,1820,2679,6305], () => (__webpack_exec__(6535)));
