...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,middlewares_PublicHandler__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)().get(async (req, res)=>{
    const { id  } = req.query;
    const data = await (0,libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("provinsi").where("id", id).first();
    const kabkota = await (0,libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("kabkota").where("provinsi_id", id).orderBy("kabkota", "asc");
    const result = {
        result: data,
        kabkota: kabkota
    };
...
var __webpack_exports__ = (__webpack_exec__(9201));
