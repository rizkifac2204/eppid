...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,middlewares_PublicHandler__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)().get(async (req, res)=>{
    ...
    const data = await libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"].select */ .Z.select("kabkota.*", "kabkota_jenis.jenis").from("kabkota").innerJoin("kabkota_jenis", "kabkota_jenis.id", "kabkota.jenis_id").where("kabkota.id", id_kabkota).first();
    res.json(data);
}));
