...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,middlewares_Handler__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)().get(async (req, res)=>{
    ...
    try {
        ...
        const cek = await libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"].select */ .Z.select("file", "bawaslu_id").from("dip").where("id", id).first();
        const proses = await (0,libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("dip").where("id", id).del();
        if (!proses) return res.status(400).json({
            message: "Gagal Hapus"
        });
        if (cek) (0,services_UploadService__WEBPACK_IMPORTED_MODULE_3__/* .DeleteUpload */ ._0)(`./public/dip/${cek.bawaslu_id}`, cek.file);
        res.json({
...
var __webpack_exports__ = __webpack_require__.X(0, [4383,1820,2679,6305,8595], () => (__webpack_exec__(5991)));
