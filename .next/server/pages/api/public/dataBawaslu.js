...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,middlewares_PublicHandler__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)().get(async (req, res)=>{
    try {
        const data = await libs_db__WEBPACK_IMPORTED_MODULE_0__/* ["default"].select */ .Z.select("bawaslu.*", "provinsi.provinsi", "kabkota.kabkota").from("bawaslu").leftJoin("provinsi", "provinsi.id", "bawaslu.id").leftJoin("kabkota", "kabkota.id", "bawaslu.id").orderBy("bawaslu.id", "asc");
...
var __webpack_exports__ = __webpack_require__.X(0, [4383], () => (__webpack_exec__(4066)));
